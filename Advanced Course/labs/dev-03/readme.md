...
If your GitLab supports environment-scoped variables, use them.
...
* (optional) Writing a small `/env` route in Flask (only in dev) that shows which DB is configured (for the workshop).
